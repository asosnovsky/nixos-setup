# Source: https://github.com/arnarg/config/blob/3cfad29004a92d310871a56605aa84df1b13741f/hosts/terra/fan2go.nix
{ lib
, config
, pkgs
, ...
...
let
  cfg = config.homelab.hardware.fan2go;
...
in
{
  options.homelab.hardware.fan2go = with lib; {
