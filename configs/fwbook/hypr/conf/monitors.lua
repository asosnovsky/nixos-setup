...
hl.monitor({ output = "eDP-1", mode = "2256x1504@60", position = "859x1080", scale = 1.57 })

-- Work monitor (ASUS VE278)
hl.monitor({
    output = "desc:Ancor Communications Inc ASUS VE278 E5LMTF016849",
    mode = "1920x1080@60",
    position = "1027x0",
    scale = 1,
})
...
hl.monitor({
    output = "desc:Dell Inc. DELL SE3223Q 1WDWKK3",
    mode = "preferred",
    position = "4780x0",
    scale = 2,
})
hl.monitor({
    output = "desc:Dell Inc. DELL SE3223Q 1TRXKK3",
    mode = "preferred",
    position = "6700x0",
    scale = 2,
})
