...
-- niri: toggle-overview via 4-finger swipe (mirrors Mod+Tab in keybindings.lua).
-- Swipe up opens, swipe down closes; gestures are discrete triggers, no
-- swipe-progress animation is possible via hl.gesture.
hl.gesture({
    fingers = 4,
    direction = "up",
    action = function()
