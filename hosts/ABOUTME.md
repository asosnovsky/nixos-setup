...
├── <hostname>.disko.nix                 # Optional: declarative disk layout for `skyg remote install` (nixos-anywhere).
│                                         # Only present for hosts installed/reinstalled this way (currently: hl-fws1)
└── scripts/
